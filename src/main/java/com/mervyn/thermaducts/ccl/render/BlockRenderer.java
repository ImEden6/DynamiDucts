...
public class BlockRenderer {
  ...
  public static class BlockFace implements IVertexSource {
    ...
    public Vertex5[] verts =
        new Vertex5[] {new Vertex5(), new Vertex5(), new Vertex5(), new Vertex5()};
  ...
  public static class FullBlock implements IVertexSource {
    ...
    public boolean hasAttribute(AttributeKey<?> attr) {
      return SideAttribute.attributeKey.equals(attr)
          || LightCoordAttribute.attributeKey.equals(attr);
    }
  ...
  /**
   * Renders faces of a block-like model based on a sideMask. Eg for side 2, verts 8-11 will be
   * rendered
   *
