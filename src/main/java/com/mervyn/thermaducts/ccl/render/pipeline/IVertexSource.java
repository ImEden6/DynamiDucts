...
public interface IVertexSource {
   ...
   * @return The {@code T} for the given {@link AttributeKey} or {@code null} of the Attribute does
   *     not exist.
   */
  @Nullable
   ...
   *
   * <p>The {@link IVertexSource} will either return data from {@link #getAttribute(AttributeKey)}
