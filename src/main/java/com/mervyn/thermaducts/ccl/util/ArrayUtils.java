...
public class ArrayUtils {
  ...
  /**
   * Fills the array with the specified value. If the value is an instance of Copyable it will call
   * copy.
   *
  ...
  /**
   * Fills the array with the specified value. A Function is used to check if the value should be
   * replaced. If the value is an instance of Copyable it will call copy.
   *
   * @param array Array to fill.
   * @param value Value to fill with.
  ...
  /**
   * Apples the Specified function to the entire array and returns a new List of the result. The
   * input to the function may be null.
   *
  ...
  /**
   * Returns the index of the first occurrence of the specified element in the array. Will return -1
   * if the element is non existent in the array.
   *
  ...
  /**
   * Returns the index of the first occurrence of the specified element in the array with the same
   * identity. (Ref compare). Will return -1 if the element is non existent in the array.
   *
   * @param array The array to search.
   * @param object Element to find.
   * @return The index in the array of the object.
  ...
  /**
   * Create a new array using the provided array as a template for the type and with the provided
   * length.
   *
  ...
  /**
   * Rolls the array based on the shift. Positive shift means the array will roll to the right.
  ...
  /**
   * Creates the inverse of an array. If the input array does not contain an element from the
   * allElements array, then it is added to the output.
   *
   * @param input The input.
