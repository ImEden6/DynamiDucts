...
public class DDBlockEntities {
  ...
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EnergyDuctBlockEntity>>
      ENERGY_DUCT_BASIC =
          BLOCK_ENTITIES.register(
              "energy_duct_basic",
              () ->
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              DDBlockEntities.ENERGY_DUCT_BASIC.get(),
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.BASIC),
                  ...
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              ...
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.HARDENED),
                      DDBlocks.ENERGY_DUCT_HARDENED.get()));
                  ...
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              ...
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.REINFORCED),
                  ...
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              ...
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.SIGNALUM),
                  ...
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              ...
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.RESONANT),
                  ...
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              ...
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.SUPERCONDUCTOR),
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              DDBlockEntities.ENERGY_DUCT_REINFORCED_EMPTY.get(),
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.REINFORCED_EMPTY),
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              DDBlockEntities.ENERGY_DUCT_SIGNALUM_EMPTY.get(),
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.SIGNALUM_EMPTY),
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              DDBlockEntities.ENERGY_DUCT_RESONANT_EMPTY.get(),
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.RESONANT_EMPTY),
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<EnergyDuctBlockEntity>(
                      (pos, state) ->
                          new EnergyDuctBlockEntity(
                              DDBlockEntities.ENERGY_DUCT_SUPERCONDUCTOR_EMPTY.get(),
                              pos,
                              state,
                              EnergyDuctBlockEntity.Tier.SUPERCONDUCTOR_EMPTY),
                      DDBlocks.ENERGY_DUCT_SUPERCONDUCTOR_EMPTY.get()));

  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FluidDuctBlockEntity>>
      FLUID_DUCT_BASIC =
          BLOCK_ENTITIES.register(
              "fluid_duct_basic",
              () ->
                  new BlockEntityType<FluidDuctBlockEntity>(
                      (pos, state) ->
                          new FluidDuctBlockEntity(
                              DDBlockEntities.FLUID_DUCT_BASIC.get(),
                              pos,
                              state,
                              FluidDuctBlockEntity.Tier.BASIC,
                              false),
                  ...
                  new BlockEntityType<FluidDuctBlockEntity>(
                      (pos, state) ->
                          new FluidDuctBlockEntity(
                              ...
                              pos,
                              state,
                              FluidDuctBlockEntity.Tier.HARDENED,
                              false),
                  ...
                  new BlockEntityType<FluidDuctBlockEntity>(
                      (pos, state) ->
                          new FluidDuctBlockEntity(
                              ...
                              pos,
                              state,
                              FluidDuctBlockEntity.Tier.ENERGY,
                              false),
                  ...
                  new BlockEntityType<FluidDuctBlockEntity>(
                      (pos, state) ->
                          new FluidDuctBlockEntity(
                              ...
                              pos,
                              state,
                              FluidDuctBlockEntity.Tier.SUPER,
                              false),
  ...
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
      ITEM_DUCT_BASIC =
          BLOCK_ENTITIES.register(
              "item_duct_basic",
              () ->
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              DDBlockEntities.ITEM_DUCT_BASIC.get(),
                              pos,
                              state,
                              ItemDuctBlockEntity.Tier.BASIC,
                              false),
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              ItemDuctBlockEntity.Tier.BASIC,
                              true),
                      DDBlocks.ITEM_DUCT_BASIC_OPAQUE.get()));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
      ITEM_DUCT_DENSE =
          BLOCK_ENTITIES.register(
              "item_duct_dense",
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              pos,
                              state,
                              ItemDuctBlockEntity.Tier.DENSE,
                              false),
                      DDBlocks.ITEM_DUCT_DENSE.get()));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              ItemDuctBlockEntity.Tier.DENSE,
                              true),
                      DDBlocks.ITEM_DUCT_DENSE_OPAQUE.get()));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
      ITEM_DUCT_VACUUM =
          BLOCK_ENTITIES.register(
              "item_duct_vacuum",
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              pos,
                              state,
                              ItemDuctBlockEntity.Tier.VACUUM,
                              false),
                      DDBlocks.ITEM_DUCT_VACUUM.get()));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              ItemDuctBlockEntity.Tier.VACUUM,
                              true),
                      DDBlocks.ITEM_DUCT_VACUUM_OPAQUE.get()));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ItemDuctBlockEntity>>
      ITEM_DUCT_FAST =
          BLOCK_ENTITIES.register(
              "item_duct_fast",
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              pos,
                              state,
                              ItemDuctBlockEntity.Tier.ENERGY,
                              false),
                  ...
                  new BlockEntityType<ItemDuctBlockEntity>(
                      (pos, state) ->
                          new ItemDuctBlockEntity(
                              ...
                              pos,
                              state,
                              ItemDuctBlockEntity.Tier.ENERGY_FAST,
                              false),
  ...
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TransportDuctBlockEntity>>
      TRANSPORT_DUCT_BASIC =
          BLOCK_ENTITIES.register(
              "transport_duct_basic",
              () ->
                  new BlockEntityType<TransportDuctBlockEntity>(
                      (pos, state) ->
                          new TransportDuctBlockEntity(
                              DDBlockEntities.TRANSPORT_DUCT_BASIC.get(),
                              pos,
                              state,
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<TransportDuctBlockEntity>(
                      (pos, state) ->
                          new TransportDuctBlockEntity(
                              DDBlockEntities.TRANSPORT_DUCT_LONG_RANGE.get(),
                              pos,
                              state,
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<TransportDuctBlockEntity>(
                      (pos, state) ->
                          new TransportDuctBlockEntity(
                              DDBlockEntities.TRANSPORT_DUCT_LINKING.get(),
                              pos,
                              state,
          ...
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<TransportDuctBlockEntity>(
                      (pos, state) ->
                          new TransportDuctBlockEntity(
                              DDBlockEntities.TRANSPORT_DUCT_FRAME.get(),
                              pos,
                              state,
                              TransportDuctBlockEntity.Tier.FRAME),
                      DDBlocks.TRANSPORT_DUCT_FRAME.get()));

  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<StructuralDuctBlockEntity>>
      STRUCTURAL_DUCT =
          BLOCK_ENTITIES.register(
              "structural_duct",
              () ->
                  new BlockEntityType<StructuralDuctBlockEntity>(
                      (pos, state) ->
                          new StructuralDuctBlockEntity(
                              DDBlockEntities.STRUCTURAL_DUCT.get(), pos, state),
      ...
      LUX_DUCT =
          BLOCK_ENTITIES.register(
              ...
              () ->
                  new BlockEntityType<StructuralDuctBlockEntity>(
                      (pos, state) ->
                          new StructuralDuctBlockEntity(DDBlockEntities.LUX_DUCT.get(), pos, state),
                      DDBlocks.LUX_DUCT.get()));
}
