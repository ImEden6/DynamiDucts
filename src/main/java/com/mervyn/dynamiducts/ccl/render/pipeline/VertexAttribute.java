 ...
 * loading of the attribute from an Attribute provided by {@link
...
public abstract class VertexAttribute<T> implements IVertexOperation {
  ...
  /**
   * Set to true when the attribute is part of the pipeline. Should only be managed by CCRenderState
