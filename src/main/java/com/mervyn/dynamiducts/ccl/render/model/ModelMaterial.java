...
public class ModelMaterial implements Copyable<ModelMaterial> {
  ...
  public static final AttributeKey<ModelMaterial> MATERIAL_KEY =
      new AttributeKey<>("material") {
        @Override
        ...
        @Override
        public ModelMaterial copyRange(
            ModelMaterial src, int srcpos, ModelMaterial dest, int destpos, int length) {
