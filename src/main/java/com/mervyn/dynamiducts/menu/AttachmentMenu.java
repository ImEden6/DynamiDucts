...
public class AttachmentMenu extends AbstractContainerMenu {
  ...
  public AttachmentMenu(
      ...
      Direction side,
      ConnectionBase attachment) {
    super(DDMenuTypes.ATTACHMENT_MENU.get(), containerId);
  ...
  public static AttachmentMenu fromNetwork(
    ...
    if (conn == null && ductBE != null) {
      ...
      conn.setRedstoneMode(
          RedstoneMode.values()[Math.min(redstoneModeOrdinal, RedstoneMode.values().length - 1)]);
