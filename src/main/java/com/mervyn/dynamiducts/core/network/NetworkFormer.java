...
public class NetworkFormer {
  ...
  public static <T extends DuctUnit<T, G, ?>, G extends NetworkGrid<T>> void formGrid(
      T startUnit, ServerLevel level) {
    ...
    while (!toCheck.isEmpty()) {
      ...
      for (Direction dir : Direction.values()) {
        ...
        G neighborGrid = neighbor.getGrid();
  ...
  private static <T extends DuctUnit<T, G, ?>, G extends NetworkGrid<T>> G mergeGrids(
      G target, G source) {
