...
public class RouteCache {
  ...
  public List<Route> getSortedRoutes(
      ItemDuctUnit origin, Set<ItemDuctUnit> allNodes, int routeType) {
    ...
    switch (routeType) {
      case FilterLogic.ROUTE_TYPE_FURTHEST ->
  ...
  public Route getRouteBetween(
      ItemDuctUnit from, ItemDuctUnit to, Direction insertionSide, Set<ItemDuctUnit> allNodes) {
